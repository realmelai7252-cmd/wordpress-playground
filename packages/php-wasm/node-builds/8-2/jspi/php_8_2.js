...
const dependencyFilename = path.join(currentDirPath, '8_2_1', 'php_8_2.wasm');
export { dependencyFilename };
export const dependenciesTotalSize = 22378245;
const phpVersionString = '8.2.1';
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _core_globals = (Module['_core_globals'] = 12892656);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 12753056);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 12753060);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 12753064);

	var _sapi_module = (Module['_sapi_module'] = 12834216);

	var _sapi_globals = (Module['_sapi_globals'] = 12834360);

	var _compiler_globals = (Module['_compiler_globals'] = 12895984);

	var _executor_globals = (Module['_executor_globals'] = 12896368);

	var _zend_compile_file = (Module['_zend_compile_file'] = 12897576);

	var _zend_execute_ex = (Module['_zend_execute_ex'] = 12895792);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 12895796);

	var _empty_fcall_info = (Module['_empty_fcall_info'] = 9376120);

	var _empty_fcall_info_cache = (Module['_empty_fcall_info_cache'] = 9376168);

	var _zend_write = (Module['_zend_write'] = 12895904);

	var _zend_error_cb = (Module['_zend_error_cb'] = 12895908);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 12895888);

	var _module_registry = (Module['_module_registry'] = 12895808);

	var _zend_extensions = (Module['_zend_extensions'] = 12893496);

	var _zend_empty_array = (Module['_zend_empty_array'] = 12245792);

	var _zend_pass_function = (Module['_zend_pass_function'] = 12230976);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 12748232);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 12748236);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 12748248);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 12893752);

	var _zend_ce_error = (Module['_zend_ce_error'] = 12893868);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 12893736);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		12893748);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 12894748);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 12854416);

	var _zend_empty_string = (Module['_zend_empty_string'] = 12746704);

	var _zend_known_strings = (Module['_zend_known_strings'] = 12746708);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		12746772);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 12746784);

	var _std_object_handlers = (Module['_std_object_handlers'] = 11827584);

	var ___memory_base = (Module['___memory_base'] = 0);

	var ___table_base = (Module['___table_base'] = 1);

	var _stderr = (Module['_stderr'] = 12739584);

	var _stdin = (Module['_stdin'] = 12739736);

	var _stdout = (Module['_stdout'] = 12739888);

	var _z_errmsg = (Module['_z_errmsg'] = 12247312);

	var _timezone = (Module['_timezone'] = 13232864);

	var _tzname = (Module['_tzname'] = 13232872);

	var ___heap_base = 14295136;

	var __ZNSt3__25ctypeIcE2idE = (Module['__ZNSt3__25ctypeIcE2idE'] =
		13246540);

	var __ZSt7nothrow = (Module['__ZSt7nothrow'] = 11825418);
	...
	var __ZTVSt12length_error = (Module['__ZTVSt12length_error'] = 12740424);

	var __ZTISt12length_error = (Module['__ZTISt12length_error'] = 12740444);
