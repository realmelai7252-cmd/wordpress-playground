...
export const dependenciesTotalSize = 24728450;
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _core_globals = (Module['_core_globals'] = 15558384);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 15447264);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 15447268);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 15447272);

	var _sapi_module = (Module['_sapi_module'] = 15442440);

	var _sapi_globals = (Module['_sapi_globals'] = 15442584);

	var _module_registry = (Module['_module_registry'] = 15560344);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 15553996);

	var _compiler_globals = (Module['_compiler_globals'] = 15561896);

	var _executor_globals = (Module['_executor_globals'] = 15562312);

	var _zend_compile_file = (Module['_zend_compile_file'] = 15563704);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 15559468);

	var _zend_ce_error = (Module['_zend_ce_error'] = 15559584);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		15559460);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 15559464);

	var _zend_execute_ex = (Module['_zend_execute_ex'] = 15560724);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 15560728);

	var _empty_fcall_info = (Module['_empty_fcall_info'] = 11257888);

	var _empty_fcall_info_cache = (Module['_empty_fcall_info_cache'] =
		11257936);

	var _zend_pass_function = (Module['_zend_pass_function'] = 14924256);

	var _zend_extensions = (Module['_zend_extensions'] = 15559212);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 15560720);

	var _zend_empty_array = (Module['_zend_empty_array'] = 14939168);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 15441808);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 15441812);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 15441824);

	var _std_object_handlers = (Module['_std_object_handlers'] = 14938656);

	var _zend_empty_string = (Module['_zend_empty_string'] = 15440320);

	var _zend_known_strings = (Module['_zend_known_strings'] = 15440324);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		15440388);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 15440400);

	var _zend_write = (Module['_zend_write'] = 15561812);

	var _zend_error_cb = (Module['_zend_error_cb'] = 15561816);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 15561784);

	var ___memory_base = (Module['___memory_base'] = 0);

	var ___table_base = (Module['___table_base'] = 1);

	var _stderr = (Module['_stderr'] = 15433200);

	var _stdout = (Module['_stdout'] = 15433504);

	var _stdin = (Module['_stdin'] = 15433352);

	var _z_errmsg = (Module['_z_errmsg'] = 14940848);

	var _timezone = (Module['_timezone'] = 15898992);

	var _tzname = (Module['_tzname'] = 15899e3);

	var ___heap_base = 16961264;

	var __ZNSt3__25ctypeIcE2idE = (Module['__ZNSt3__25ctypeIcE2idE'] =
		15912668);

	var __ZSt7nothrow = (Module['__ZSt7nothrow'] = 13708266);
	...
	var __ZTVSt12length_error = (Module['__ZTVSt12length_error'] = 15434040);

	var __ZTISt12length_error = (Module['__ZTISt12length_error'] = 15434060);
