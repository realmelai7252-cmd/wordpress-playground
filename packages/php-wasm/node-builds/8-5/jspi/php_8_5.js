...
export const dependenciesTotalSize = 26004287;
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var Asyncify = {
		...
		instrumentWasmExports(exports) {
			var exportPattern =
				/^(php_wasm_init|wasm_sleep|wasm_read|emscripten_sleep|wasm_sapi_handle_request|wasm_sapi_request_shutdown|wasm_poll_socket|wrap_select|__wrap_select|select|php_pollfd_for|fflush|wasm_popen|wasm_read|wasm_php_exec|run_cli|wasm_recv|wasm_connect|__wasm_call_ctors|__errno_location|__funcs_on_exit|main|__main_argc_argv)$/;
	...
	function assignWasmExports(wasmExports) {
		...
		_PHP_MD5InitArgs = Module['_PHP_MD5InitArgs'] =
			wasmExports['PHP_MD5InitArgs'];
		...
		_zend_zval_value_name = Module['_zend_zval_value_name'] =
			wasmExports['zend_zval_value_name'];
		...
		_zend_argument_must_not_be_empty_error = Module[
			'_zend_argument_must_not_be_empty_error'
		] = wasmExports['zend_argument_must_not_be_empty_error'];
		_zend_parse_arg_bool_slow = Module['_zend_parse_arg_bool_slow'] =
			wasmExports['zend_parse_arg_bool_slow'];
		_zend_flf_parse_arg_bool_slow = Module[
			'_zend_flf_parse_arg_bool_slow'
		] = wasmExports['zend_flf_parse_arg_bool_slow'];
		_zend_parse_arg_long_slow = Module['_zend_parse_arg_long_slow'] =
			wasmExports['zend_parse_arg_long_slow'];
		_zend_flf_parse_arg_long_slow = Module[
			'_zend_flf_parse_arg_long_slow'
		] = wasmExports['zend_flf_parse_arg_long_slow'];
		...
		_zend_flf_parse_arg_str_slow = Module['_zend_flf_parse_arg_str_slow'] =
			wasmExports['zend_flf_parse_arg_str_slow'];
		...
		_object_init_with_constructor = Module[
			'_object_init_with_constructor'
		] = wasmExports['object_init_with_constructor'];
		...
		_zend_is_graceful_exit = Module['_zend_is_graceful_exit'] =
			wasmExports['zend_is_graceful_exit'];
		...
		_zend_array_to_list = Module['_zend_array_to_list'] =
			wasmExports['zend_array_to_list'];
		...
		_zend_ini_parse_quantity_warn = Module[
			'_zend_ini_parse_quantity_warn'
		] = wasmExports['zend_ini_parse_quantity_warn'];
		...
		_zend_get_properties_no_lazy_init = Module[
			'_zend_get_properties_no_lazy_init'
		] = wasmExports['zend_get_properties_no_lazy_init'];
		...
		_zval_ptr_safe_dtor = Module['_zval_ptr_safe_dtor'] =
			wasmExports['zval_ptr_safe_dtor'];
		...
		_zend_illegal_container_offset = Module[
			'_zend_illegal_container_offset'
		] = wasmExports['zend_illegal_container_offset'];
		...
		_pthread_cond_broadcast = Module['_pthread_cond_broadcast'] =
			wasmExports['pthread_cond_broadcast'];
	...
	var _core_globals = (Module['_core_globals'] = 18167960);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 18055808);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 18055812);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 18055816);

	var _sapi_module = (Module['_sapi_module'] = 18050976);

	var _sapi_globals = (Module['_sapi_globals'] = 18051128);

	var _module_registry = (Module['_module_registry'] = 18170896);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 18168828);

	var _compiler_globals = (Module['_compiler_globals'] = 18172520);

	var _executor_globals = (Module['_executor_globals'] = 18172936);

	var _zend_compile_file = (Module['_zend_compile_file'] = 18174352);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 18168956);

	var _zend_ce_error = (Module['_zend_ce_error'] = 18169080);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		18168952);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 18168960);

	var _zend_execute_ex = (Module['_zend_execute_ex'] = 18170880);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 18170884);

	var _zend_pass_function = (Module['_zend_pass_function'] = 17532416);

	var _zend_extensions = (Module['_zend_extensions'] = 18168796);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 18171280);

	var _zend_empty_array = (Module['_zend_empty_array'] = 17547728);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 18050336);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 18050340);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 18050352);

	var _std_object_handlers = (Module['_std_object_handlers'] = 17531120);

	var _zend_empty_string = (Module['_zend_empty_string'] = 18171284);

	var _zend_known_strings = (Module['_zend_known_strings'] = 18171288);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		18171356);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 18171376);

	var _zend_write = (Module['_zend_write'] = 18172436);

	var _zend_error_cb = (Module['_zend_error_cb'] = 18172440);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 18172408);

	var ___memory_base = (Module['___memory_base'] = 0);

	var ___table_base = (Module['___table_base'] = 1);

	var _stderr = (Module['_stderr'] = 18042624);

	var _stdout = (Module['_stdout'] = 18042928);

	var _stdin = (Module['_stdin'] = 18042776);

	var _z_errmsg = (Module['_z_errmsg'] = 17550288);

	var _timezone = (Module['_timezone'] = 18509632);

	var _tzname = (Module['_tzname'] = 18509640);

	var ___heap_base = 19571904;

	var __ZNSt3__25ctypeIcE2idE = (Module['__ZNSt3__25ctypeIcE2idE'] =
		18523308);

	var __ZSt7nothrow = (Module['__ZSt7nothrow'] = 16310698);
	...
	var __ZTVSt12length_error = (Module['__ZTVSt12length_error'] = 18043464);

	var __ZTISt12length_error = (Module['__ZTISt12length_error'] = 18043484);
