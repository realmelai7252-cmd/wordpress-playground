...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _php_date_get_date_ce,
		...
		_compare_function,
		_instanceof_function_ex,
		_instanceof_function,
	...
	function assignWasmExports(wasmExports) {
		...
		__call_user_function_ex = Module['__call_user_function_ex'] =
			wasmExports['_call_user_function_ex'];
		...
		_instanceof_function_ex = Module['_instanceof_function_ex'] =
			wasmExports['instanceof_function_ex'];
		_instanceof_function = Module['_instanceof_function'] =
			wasmExports['instanceof_function'];
		...
		_zend_wrong_parameters_none_exception = Module[
			'_zend_wrong_parameters_none_exception'
		] = wasmExports['zend_wrong_parameters_none_exception'];
		...
		_zend_wrong_callback_deprecated = Module[
			'_zend_wrong_callback_deprecated'
		] = wasmExports['zend_wrong_callback_deprecated'];
		...
		_zend_parse_parameters_throw = Module['_zend_parse_parameters_throw'] =
			wasmExports['zend_parse_parameters_throw'];
		...
		_zend_register_internal_class = Module[
			'_zend_register_internal_class'
